                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
									<?php
									$select_stmt=$db->prepare("SELECT * FROM tblemployeeslogin");	//sql select query
									$select_stmt->execute();
									...
									?>
                                        <tr>
											...
											<td><?php echo $row['field_role']; ?></td>
                                            <td><a href="edit.php?update_id=<?php echo $row['field_user_id']; ?>" class="btn btn-warning">Edit</a></td>
                                            <td><a href="?delete_id=<?php echo $row['field_user_id']; ?>" class="btn btn-danger">Delete</a></td>
                                        </tr>
                                    <?php
									}
									?>
