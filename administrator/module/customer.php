        ...
        <div class="col-xs-12">
          <!-- <div class="box"> -->
            ...
            <div class="box-header">
              ...
              <h3 class="box-title"><a href="?module=addcustomer" class="text-white btn btn-info "><i class="fa fa-plus"></i> Add Customer</a></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                 ...
                 <tr>
                  ...
                  <td ata-title="Trx Id" >                   
                    ...
                    if ($row["field_status_aktif"]=="1") {
                      ...
                      echo '<a href="?module=updcustomer&id='.$row["field_user_id"].'" class="text-white btn btn-primary "><i class="fa fa-play "></i></a>&nbsp';
                      echo '<a href="#" data-toggle="modal" data-target="#modal-default'.$row["field_user_id"].'" class="text-white btn btn-danger "><i class="fa fa-trash"></i></a> &nbsp';  
                    }
                     ?>                    
