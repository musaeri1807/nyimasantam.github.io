...
if (isset($_POST['payment'])) {
  ...
  echo '<hr>';
  $transaksi_produk = $_POST['txt_contoh'];
          ...
          <div class="row">
            <div class="col-xs-12 table-responsive">
              ...
              <table class="table table-bordered table-striped table-hover" id="table-pembelian">
                ...
                <tbody>
                  <th><input type="text" name="txt_contoh"></th>
                  <th><input type="text" name=""></th>
                  <th style="text-align: center;"><input type="text" name=""></th>
                  <th style="text-align: center;"><input type="text" name=""></th>
                  <th style="text-align: center;"><input type="text" name=""></th>
                  <th width="1%" style="text-align: center;"><input type="text" name=""></th>
                </tbody>
                <tfoot>
                  <tr class="bg-info">
