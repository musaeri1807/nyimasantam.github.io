        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header">
              ...
              <a data-toggle="modal" data-target="#modal-default-category" class="btn btn-success  pull-right"><i class="fa fa-plus"></i> Add Category</a>        
            </div>     
              <!-- Content --> 
              <!-- modal add -->
            ...
            <div class="box-body">
              ...
              ?> 
                 ...
                 <tr>
                  ...
                  <td data-title="Code C"><?php echo sprintf("%03s",$row['field_category_id']);?></td>
                  <td data-title="Trx Id"><?php echo $row["field_name_category"] ?></td>
                  <td ><?php echo $row["field_type_product"]; ?></td>
              ...
              <!-- modal update-->
              <div class="modal fade" id="modal-update-category<?php echo $row["field_category_id"];?>">
                    <div class="modal-dialog">
                    <div class="modal-content">
                    <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                    <center><h4 class="modal-title">Update Category <?php echo $row["field_category_id"]?></h4></center>
                    </div>
                    <div class="modal-body">
                    <form method="post" class="form-horizontal">
											<div class="form-group">
											  <div class="box-header">
                          <input type="hidden" name="txt_idcategory" value="<?php echo $row['field_category_id']?>">
													<input type="text" name="txt_category" class="form-control" value="<?php echo $row["field_name_category"]?>" />
												</div>
												<div class="box-header">
												<select class="form-control" name="txt_group_category">
												<option value="<?php echo $row["field_type_product"]?>"><?php echo $row["field_type_product"]?></option>
												<option value="Anorganic">Anorganic</option>
												<option value="Organic">Organic</option>
												<option value="B3">B3</option>
												<option value="Rupiah">Rupiah</option>
