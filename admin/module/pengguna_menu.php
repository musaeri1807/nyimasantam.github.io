...
$Sql = "SELECT * FROM tblemployeaccessmenu  ORDER BY field_role_id ASC";
$Stmt = $db->prepare($Sql);
$Stmt->execute();
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header">
          ...
          <h3 class="box-title">Pengguna Menu</h3>
            ...
            <tbody>
              ...
              ?>
                ...
                <tr>
                  ...
                  <td><?php echo $no; ?></td>
                  <td data-title="Trx Id"><?php echo $row["field_idmenu"]; ?></td>
                  <td data-title="Trx Id"><?php echo $row["field_role_id"]; ?></td>
                  <td><?php $row["field_role_id"]; ?> </td>
