...
if(isset($_REQUEST['btn_update']))
{
	...
	else
	{
		try
		{
			if(!isset($errorMsg))
			{
				$update_stmt=$db->prepare('UPDATE tblemployeeslogin SET field_username=:fname_up, field_email=:lname_up WHERE field_user_id=:id'); //sql update query
	...
	<div class="container">
		...
		?>   
			...
			<form method="post" class="form-horizontal">
				...
				<div class="col-sm-6">
				<input type="text" name="txt_firstname" class="form-control" value="<?php echo $field_username; ?>">
				</div>
				</div>
				...
				<div class="col-sm-6">
				<input type="text" name="txt_lastname" class="form-control" value="<?php echo $field_email; ?>">
				</div>
				</div>
