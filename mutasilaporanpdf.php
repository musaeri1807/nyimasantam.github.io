...
$sqlT = "SELECT * FROM tbltrxmutasisaldo WHERE field_member_id=$member_id AND date(field_tanggal_saldo) >= '$tgl_dari' AND date(field_tanggal_saldo) <= '$tgl_sampai' AND  field_status='Success' ORDER BY field_id_saldo ASC";
