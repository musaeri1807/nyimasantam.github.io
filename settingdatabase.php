...
<div class="lockscreen-wrapper">
  <div class="lockscreen-logo">
    <a href="../../index2.html"><b>Setting </b>Database</a>
  </div>
  <!-- User name -->
    ...
    <!-- lockscreen credentials (contains the form) -->
      <form role="form" method="POST" >              
          <div class="form-group" >
            <input type="text" class="form-control" name="HostName" value="nyimasantam.my.id" placeholder="HostName" required>
            </div>
          <div class="form-group">           
            <input type="text" class="form-control" name="UserName" value="musaeri0789"  placeholder="UserName" required>
          </div>                    
          <div class="form-group">       
          <input type="Password" class="form-control" name="Password" value="P@55w.rdmusaeri.123#" placeholder="Password">
          </div>
          <div class="form-group">
          <input type="text" class="form-control" name="DatabaseName" value="VPS01NACOM" placeholder="DatabaseName" required>
          </div> 
           <center> 
