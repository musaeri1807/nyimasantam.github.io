<?php
//$nama         = 'Muhammad Gavin Alhanan Bin Musaeri';
//$email        = 'panjisetyokurniawan@gmail.com';
...
//$mail->addAttachment('/images/email.png', 'new.jpg');    // Optional name
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              ...
              <tr>
                <td class="logo" style="text-align: center;">
                  ...
                  <h2>'.$nama.'</h2> 
                  <P><h3>Anda melakukan Reset Password Aplikasi Nyimasantam<br>
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                <td style="padding: 1 1.5em; text-align: center; padding-bottom: 0em;">
                 <a href="https://nyimasantam.my.id/changepswd?t='.$tokenn.'" class="btn btn-primary">Ubah Sandi</a>
                </td>                  
              </tr>
              <tr>
                <td style="text-align: center;">
                  <div>                   
                    <p><a href="https://nyimasantam.my.id/changepswd?t='.$tokenn.'" >https://nyimasantam.my.id/activ?t='.$tokenn.'</a></p>
                  </div>
                </td>
              </tr>
            </table> 
